 ...
 * @author ricolwang
 */
public class EnemyAutoMissileWeapon extends EnemyWeapon
{

    public EnemyAutoMissileWeapon(Spaceship theShip)
    {
        super(theShip);
    }
...
//        aMissile.bDrawFrame = true;
        ...
        ((SpaceShipScene) this.theShip.theScene).addAEnemyMissile(aMissile);
